          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  FadeAnimation(1, Text("its Yummy!",
                    style: TextStyle(color: Colors.yellowAccent, fontSize: 50,fontStyle: FontStyle.italic),)),
                  SizedBox(height: 15,),
                  FadeAnimation(1.3, Text("we go together like milk and cookies",
                    style:TextStyle(color: Colors.orange,fontStyle:FontStyle.italic,fontSize: 24) ,)),
                  SizedBox(height: 180,),
